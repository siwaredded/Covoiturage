...
<meta name="theme-color" content="#7952b3">
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-white">
      <div class="container-fluid">
        <a href=""><img src="{{ asset('/images/COVOITURAGE.PNG') }}" width="180" height="30">
...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p class="lead text-muted"> Ici,vous pouvez consulter la liste des utilisateurs, la liste des réservations et la liste des publications de covoiturage</p>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Mes réservations" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#3A9D23"/><text style="color: #ffffff; font-family: 'Raleway',sans-serif ;font-weight: 400; text-transform: uppercase;" x="50%" y="50%" fill="#eceeef" dy=".3em">Liste des publications</text></svg>
